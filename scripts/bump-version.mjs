...
// package-lock.json is regenerated by reading package.json and rewriting the
// versions block. We only need to bump the top-level "version" and the root
// "packages."" version; nested dependency versions are unaffected.
if (readFileSync(lockPath, "utf8") !== undefined) {
